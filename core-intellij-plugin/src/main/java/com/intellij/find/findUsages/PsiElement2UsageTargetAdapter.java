...
public class PsiElement2UsageTargetAdapter
  ...
  public static @NotNull PsiElement2UsageTargetAdapter[] convert(@NotNull PsiElement[] psiElements) {
  ...
  static @NotNull PsiElement[] convertToPsiElements(@NotNull PsiElement2UsageTargetAdapter[] adapters) {
