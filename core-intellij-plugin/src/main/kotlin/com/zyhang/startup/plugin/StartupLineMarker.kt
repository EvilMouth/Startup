...
class StartupLineMarker : LineMarkerProviderDescriptor(), GutterIconNavigationHandler<PsiElement> {
    ...
    companion object {
        private val navigationOnIcon = IconLoader.getIcon("/icons/outline_my_location_black_18dp.png")
    }
}